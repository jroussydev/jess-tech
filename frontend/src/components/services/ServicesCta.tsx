        ...
        <div className="relative overflow-hidden rounded-3xl border border-blue-500/15 bg-gradient-to-r from-[#081120] to-[#0b1d35] p-6 sm:p-8">
          ...
          <div className="relative z-10 flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-5">
              <div className="flex h-14 w-14 shrink-0 items-center justify-center  text-2xl text-blue-400 sm:h-16 sm:w-16 sm:text-3xl">
                💬
              </div>
              ...
              <div>
                ...
                adaptée, sans vous demander de connaître les termes techniques.
                </p>
              </div>
            </div>
